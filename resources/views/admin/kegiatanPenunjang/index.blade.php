    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Kegiatana Penunjang</h1>
             <a href="{{ route('frontend.kegiatanPenunjang-admin.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Tambah Data Kegiatan Penunjang</a> 
        </div>

        <div class="card mb-3">
            <div class="card-body">
                <h4>Deskripsi Kegiatan Penunjang</h4>
                <p>
